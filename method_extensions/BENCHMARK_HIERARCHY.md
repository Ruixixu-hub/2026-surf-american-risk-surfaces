...
|---|---|---|---|
| Basic / Original Classical Benchmark | CN + PSOR | Original American-option LCP benchmark | Retained |
...
Penalty/Newton is reported separately as a failed candidate comparator. It is
not a fourth benchmark because it did not pass the common correctness gate.
