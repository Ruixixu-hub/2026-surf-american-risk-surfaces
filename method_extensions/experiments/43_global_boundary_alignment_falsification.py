"""Experiment 43: global U/A ladders, gated by the transformation audit."""
...
def main() -> None:
    decision_path = RESULTS_DIR / "01_transformation_audit" / "transformation_decision.json"
