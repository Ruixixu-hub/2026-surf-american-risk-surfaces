...
literature. It mentions Brennan-Schwartz finite-difference valuation as background
\citep{brennan_schwartz_1977} and emphasizes that a trusted classical benchmark must come before
neural surrogate modelling. This reference integration pass adds the verified Black-Scholes,
finite-difference, and computational-finance sources needed for the theory context
\citep{black_scholes_1973,merton_1973,wilmott_howison_dewynne_1995} while keeping the ticket's
