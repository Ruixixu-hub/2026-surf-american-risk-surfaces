...
This reference integration pass now adds a shared bibliography for the completed solver-validation
ladder. The synthesis is connected to classical option-pricing theory
\citep{black_scholes_1973,merton_1973}, finite-difference and American option numerics
\citep{crank_nicolson_1947,brennan_schwartz_1977,wilmott_howison_dewynne_1995}, LCP methodology
\citep{cottle_pang_stone_2009}, Rannacher startup damping \citep{rannacher_1984}, and the
scientific machine-learning literature that remains future-work context
\citep{raissi_perdikaris_karniadakis_2019,sirignano_spiliopoulos_2018,becker_cheridito_jentzen_2020}.
