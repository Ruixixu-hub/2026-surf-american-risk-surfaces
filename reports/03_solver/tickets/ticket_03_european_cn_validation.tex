...
Ticket 03 follows that plan without adding a separate external bibliography. External finite-
difference and Crank-Nicolson work is relevant background, but this ticket does not invent
bibliographic details that are not already verified in the project documents.
